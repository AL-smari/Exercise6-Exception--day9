...
//          largest(num,k);
//      }catch (InputMismatchException e){
//          System.out.println("enter the right format(integer)");
//      }catch (ArrayIndexOutOfBoundsException e){
//          System.out.println("you enter a number more than the length of the array");
//      }
...
//        }
    ...
    //Q7
    public static int checkLength(String str)throws Exception {
        if(str.contains(" ")){
            throw new Exception("dont accept space");
        }
        int point;
        if (str.length() >= 8) {
            point = 3;
